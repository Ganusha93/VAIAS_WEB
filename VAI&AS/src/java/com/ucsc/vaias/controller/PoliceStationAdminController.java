 ...
 * @author Ishan
 */
public class PoliceStationAdminController extends HttpServlet {
...
//                        }
            ...
            if (type.equals("selbyID")) {
                try {
                    ...
                    String PID = request.getParameter("PID");
                    System.out.println("pooooooooooooooooooooolis"+PID);
                    policestation.setPID(PID);

                    PoliceStation res_Select =policestationservice.searchPoliceStationByPID(policestation, connection);
                    ...
                    getServletContext().getRequestDispatcher("/Admin_PoliceStation_update.jsp").forward(request, response);
                    System.out.println("polllllllllllllllllllllllllllisssss    "+res_Select.getPROVINCE());
                    System.out.println("polllllllllllllllllllllllllllisssss    "+res_Select.getPID());
                    out.flush();
                    out.close();
                    return;
            ...
            if (type.equals("update")) {
              try{  
                ...
                PoliceStationService policeService = new PoliceStationServiceImpl();
                    boolean res_Add = policeService.updatePoliceStationByPID(police, connection);

                    if (res_Add) {
                        response.sendRedirect("Admin_PoliceStation_update.jsp");
                    } else {
