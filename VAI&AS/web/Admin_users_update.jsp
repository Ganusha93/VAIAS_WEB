                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="BLOOD_GROUP" required>
                                                        <option class="form-group" value=<% try{ out.println(user.getBLOOD_GROUP());}catch(Exception e){out.println(e);} %> ><% try{ out.println(user.getBLOOD_GROUP());}catch(Exception e){out.println("");} %></option>
